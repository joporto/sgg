...
public class TransportistaDAO {
    public boolean add(edm.Transportista a) throws Exception {
    ...
    public List<edm.Transportista> getList() throws Exception {
        
        Session session = NewHibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
        try 
        {
            return (List<edm.Transportista>) session.createCriteria(edm.Transportista.class).list(); 
        } 
        catch (Exception e) 
        {
    ...
    public boolean delete(edm.Transportista a) throws Exception {
        Session session = NewHibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
        try 
        {
    ...
    public boolean update(edm.Transportista a) throws Exception {
        Session session = NewHibernateUtil.getSessionFactory().openSession();
        session.beginTransaction();
        try 
        {
